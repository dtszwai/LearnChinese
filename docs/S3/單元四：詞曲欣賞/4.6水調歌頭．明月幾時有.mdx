...
<p className="pre-text">丙辰中秋，歡飲<Tool.Annotate title="直到天亮。">達旦</Tool.Annotate>，大醉，作此篇，兼懷<Tool.Annotate title="蘇軾弟蘇轍的字。時在齊州（今山東濟南市）做官。">子由</Tool.Annotate>。</p>
...
<Tool.Tabs>
  <Tool.TabItem value="Video1" label="動畫" className="video-responsive" default>
  ...
  <Tool.TabItem value="Video2" label="鄧麗君〈但願人長久〉">
    <Tool.Youtube>CQlt3-6N1P8</Tool.Youtube>
  </Tool.TabItem>
  <Tool.TabItem value="Video3" label="天韻舞春風">
    <Tool.Youtube>mIo8rR1bAgo</Tool.Youtube>
  </Tool.TabItem>
  <Tool.TabItem value="Video4" label="招祥麒博士粵語朗誦">
